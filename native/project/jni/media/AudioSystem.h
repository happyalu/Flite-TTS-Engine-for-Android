/*
 * Copied from frameworks/base/media/AudioSystems.h in the Android sources.
 * Modified by commenting out parts that we don't need
 * (especially dependencies on other header files).
 */
/*
